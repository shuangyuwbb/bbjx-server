...
CREATE TABLE `bbjx_category` (
  ...
  `sort_order` int NOT NULL DEFAULT '0' COMMENT '排序编号,同类展示顺序,数值相等则自然排序',
...
CREATE TABLE `bbjx_product` (
  ...
  `category_id` int NOT NULL COMMENT '分类id,对应bbjx_category表的主键',
  ...
  `tip` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `bbjx_user` VALUES ('1', 'admin', '21232F297A57A5A743894A0E4A801FC3', 'admin@qq.com', null, null, null, '0', '2000-08-06 15:12:00', '2000-08-06 15:12:00');
INSERT INTO `bbjx_user` VALUES ('2', '123456', 'e10adc3949ba59abbe56e057f20f883e', '123455@qq.com', null, null, null, '1', '2021-02-14 16:20:08', '2021-02-14 16:20:08');
INSERT INTO `bbjx_user` VALUES ('3', 'xixingya', '$2a$10$cLpY17Mw1gt8t6ksfIkw7OT8ePsjxR/mRbxfxSHuy8KklmMQFzG.K', '2679431923@qq.com', null, null, null, '1', '2021-03-30 20:03:35', '2021-03-30 20:03:35');
